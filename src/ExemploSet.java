...
public class ExemploSet {
	...
	public static void main(String[] args) {
		...
		notas.clear();
		System.out.println("Conferindo se está vazio: " + notas.isEmpty());
		System.out.println("Conferindo se está vazio: " + notas2.isEmpty());
		System.out.println("Conferindo se está vazio: " + notas3.isEmpty());
		System.out.println("--------------------------------------------");
